...
def render(manifest_path, output_path):
    ...
    for episode in episodes:
        ...
        rows.append(
            ...
            "<td><span class='ok'>对话人分区已完成</span></td></tr>"
        )
        turns = []
